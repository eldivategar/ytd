...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Kuliah Amikom\Kuliah SEM 5\Pemrograman Python\Final Project\ytDownloader\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Kuliah Amikom\Kuliah SEM 5\Pemrograman Python\Final Project\ytDownloader\env\Scripts\deactivate.nu'
