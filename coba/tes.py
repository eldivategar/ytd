...
def progress_Check(stream = None, chunk = None, file_handle = None, remaining = None):
    ...
    print("{:00.0f}%d downloaded".format(percent))

#Grabs the file path for Download
def file_path():    
    download_path = "D:/Kuliah Amikom/Kuliah SEM 5/Pemrograman Python/Final Project/"
    return download_path

def start():
    print("Your video will be saved to: {}".format(file_path()))
    #Input 
    print("Copy and paste your YouTube URL here: ")
    yt_url = input("> ")
    print(yt_url)
